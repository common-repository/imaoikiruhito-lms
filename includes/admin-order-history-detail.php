...
<div id="iihlms-wrap" class="wrap">
	...
	echo '<h1 class="wp-heading-inline">' . esc_html__( '注文詳s細', 'imaoikiruhitolms' ) . '</h1>';
	...
	foreach ( $results as $result_data ) {
		...
		echo '</tr>';
		echo '<tr>';
		echo '<th scope="row">' . esc_html__( '登録日時', 'imaoikiruhitolms' ) . '</th>';
		echo '<td>' . esc_html( $registered_datetime );
		echo '<p class="description"></p>';
		echo '</td>';
		echo '</tr>';
		echo '<tr>';
